...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg bg-white sticky-top">
    ...
    <!--hero-->
        <header container= "pt-5">
            <h1 class = "text-center"> Boost your day with <br> Semangkuk Kopi</h1>
    ...
    <!--about-->
        <section>
            <div>
                <div class="row">
                    <div class="col-6">
                        <img height="600px" src="<?php echo base_url('resources/img/about.png');?>"> 
                </div>
                    <div class="col-6">
                        <div>
                            ...
                            <button type="buttton">BACA DEUI!???</button>
                        </div>
    ...
    <section id="our-coffee">
      <div class="container py-5">
        <h1 class="text-center mb-5">JAVA Coffee</h1>
        <div class="row mb-5" style="--bs-gutter-x: 4rem">
          <div class="col-4">
            <div class="img-card">
              <img width="100%" src="<?php echo base_url('resources/img/M1.png');?>">
              <div class="hover">
          ...
          <div class="col-4">
            <div class="img-card">
              <img width="100%" src="<?php echo base_url('resources/img/M2.png');?>">
              <div class="hover">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M17 9H1M9 1V17V1Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
    ...
    <section id="instagram" style="background-color:#F3F4F6;">
      <div class="container py-5">
        <div class="row mb-5" style="--bs-gutter-x: 2rem; --bs-gutter-y: 2rem">
          ...
          <div class="col-4">
            <img width="100%" src="<?php echo base_url('resources/img/r1.png');?>">
          </div>
          <div class="col-4">
            <img width="100%" src="<?php echo base_url('resources/img/r2.png');?>">
          </div>
          <div class="col-4">
            <img width="100%" src="<?php echo base_url('resources/img/r3.png');?>">
          </div>
          <div class="col-4">
            <img width="100%" src="<?php echo base_url('resources/img/r4.png');?>">
          </div>
          <div class="col-4">
            <img width="100%" src="<?php echo base_url('resources/img/r5.png');?>">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container py-5">
        <div class="row border p-5" style="--bs-border-width: 7px; --bs-gutter-x: 2rem;">
          <div class="col-6 d-flex justify-content-center">
            <img width="100%" src="<?php echo base_url('resources/img/as1.png');?>" alt="">
          </div>
    ...
    <section id="gallery">
      <div class="row" style="--bs-gutter-x: 0rem;">
        <div class="col-4">
          <img width="100%" src="<?php echo base_url('resources/img/g1.png');?>">
        </div>
        <div class="col-4">
          <img width="100%" src="<?php echo base_url('resources/img/g2.png');?>">
        </div>
        <div class="col-4">
          <img width="100%" src="<?php echo base_url('resources/img/g3.png');?>">
        </div>
      </div>
    </section>
